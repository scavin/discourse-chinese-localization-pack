module Onebox
  module Engine
    class BilibiliOnebox
      ...
      def to_html
        "<iframe src='https://player.bilibili.com/player.html?bvid=#{video_id}&high_quality=1&autoplay=0' frameborder='no' width='100%' height='430' allowfullscreen='true'></iframe>"
      end
